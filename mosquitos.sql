...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-04-2026 a las 23:43:31
...
(4, 'Juan Carlos', 'Medina', 45342132, 2233),
(5, 'Ian', 'Ortellado', 47397760, 2321);
...
INSERT INTO `usuarios` (`id_usuario`, `alias`, `pass`, `nombre`, `apellido`, `DNI`, `cod_categoria`) VALUES
(0, '', 0, '', '', 0, 1),
(1, 'admin1', 1234, 'Jane', 'Dou', 12345678, 1),
(2, 'user1', 4321, 'Jon', 'Doe', 12325678, 2),
(4, 'Ilortellado', 1111, 'Ian', 'Ortellado', 47397760, 1);
