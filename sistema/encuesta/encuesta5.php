...
<br>
            Con frecuencia (cada pocos dias) <input type="checkbox" name="dia"> <br>
<br>
            Una vez a la semana<input type="checkbox" name="semana"><br>
<br>
            Una vez al mes<input type="checkbox" name="mes"><br>
<br>
            No lo limpio<input type="checkbox" name="nunca"><br>
        </div>
<br>
        <div>
            ¿Suele estar húmedo? <br>
            <input type="radio" name="radio4" value="1">Si<br>
            <input type="radio" name="radio4" value="2">No<br>
        </div>
<br>
        <div>
...
<br>
        <div>
            ...
            <input type="radio" name="radio9" value="2">No<br> 
    </article>
    <article class="cuartos">
        <h3>Cuartos</h3>
...
<br>
    <div>
        ...
        <input type="radio" name="radio28" value="1">Si<br>
        <input type="radio" name="radio28" value="0">No<br>
    </div>
</article>
